          ...
          <div className="block md:hidden space-y-4">
            {filteredOrders.map((order) => (
              ...
              >
                ...
                <p className="text-sm"><strong>Time:</strong> {new Date(order.time).toLocaleString()}</p>
                <p className="text-sm">
              ...
              <tbody className="bg-white divide-y divide-gray-100">
                {filteredOrders.map((order) => (
                  <tr key={order.orderId} className="hover:bg-gray-50 transition">
                    ...
                    <td className="px-4 py-3 border text-gray-500 text-sm">{new Date(order.time).toLocaleString()}</td>
                    <td className="px-4 py-3 border">
                      <span
