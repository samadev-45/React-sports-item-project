    ...
    <>
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-6 md:px-20">
        <div className="max-w-xl bg-white bg-opacity-80 p-6 rounded-lg shadow-lg">
          ...
          <Link
            to="/products"
            className="inline-block px-6 py-3 bg-red-600 text-white rounded-full text-lg font-semibold hover:bg-red-700 transition duration-300"
          >
            Shop Now
          </Link>
        </div>
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              <Link to="https://www.facebook.com/">
                <span className="w-8 h-8 bg-white rounded-full flex items-center justify-center text-blue-400">
                  f
                </span>
              </Link>
